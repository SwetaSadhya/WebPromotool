...
class Model_Customer {
    ...
    public function __construct($cusID,$customerID,$countryID,$cusCustomerClientCode,$cusCustomerName,$cusGroup1ID,$cusGroup2ID,$cusGroup3ID,$cusGroup4ID,$cusGroup5ID,$cusGroup6ID,$cusGroup7ID) {
