...
class Model_CustomerHierarchy extends Model_DbConnection {
	...
	$condition =" and  h.cusGroup6ID in (".$comma_cGroup6ID.") ";
	}
	if(isset($condition) && $condition!="" )
	{
		$condition .=$condition;
		$query = "SELECT  h.customerHierarchyID, c.customerID, c.cusCustomerClientCode, c.cusCustomerName, h.cusGroup1ID, g1.cusGroup1Desc, h.cusGroup5ID,g5.cusGroup5Desc, h.cusGroup6ID, g6.cusGroup6Desc
	...
	$Hier = new Model_Hierarchy($row1['customerHierarchyID'],$row1['customerID'],$row1['cusCustomerClientCode'],$row1['cusCustomerName'],$row1['cusGroup1ID'],$row1['cusGroup1Desc'],$row1['cusGroup5ID'],$row1['cusGroup5Desc'],$row1['cusGroup6ID'],$row1['cusGroup6Desc']);
	$Hierarchy[] = $Hier ;
	}
