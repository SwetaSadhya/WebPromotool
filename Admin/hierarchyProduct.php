...
INNER Join ".PRD_G19_TABLE." g19 ON g19.prdGroup19ID = c.prdGroup19ID
INNER Join ".PRD_G20_TABLE." g20 ON g20.prdGroup20ID = c.prdGroup20ID
INNER Join ".PRD_G21_TABLE." g21 ON g21.prdGroup21ID = c.prdGroup21ID
GROUP BY g1.prdGroup1ID,g4.prdGroup4ID,g5.prdGroup5ID,g6.prdGroup6ID,g7.prdGroup7ID,g8.prdGroup8ID,g9.prdGroup9ID,g10.prdGroup10ID,g11.prdGroup11ID,g12.prdGroup12ID,g13.prdGroup13ID,g14.prdGroup14ID,g15.prdGroup15ID,g16.prdGroup16ID,g17.prdGroup17ID,g18.prdGroup18ID,g19.prdGroup19ID,g20.prdGroup20ID,g21.prdGroup21ID";
//echo $_HierQuery;
			$tbl_H = new Model;
