...
$prdCreatedOn = $objPHPExcel->getActiveSheet()->getCell($E.$row)->getValue();
$prdGST = $objPHPExcel->getActiveSheet()->getCell($F.$row)->getValue();
...
//---------------------------------------Cust Temp Table--------------------------------------------------
$prdTemQuery='INSERT INTO '.PRD_TEMP_TABLE.'(ProductID, countryID, prdProductClientCode, ProductName, prdCreatedOn, prdGST,prdNetWeight,prdNetVolume, prdGroup1ID, prdGroup1ClientID, prdGroup1Desc,prdGroup2ID, prdGroup2ClientID, prdGroup2Desc,prdGroup3ID, prdGroup3ClientID, prdGroup3Desc,prdGroup4ID, prdGroup4ClientID, prdGroup4Desc,prdGroup5ID, prdGroup5ClientID, prdGroup5Desc,prdGroup6ID, prdGroup6ClientID, prdGroup6Desc,prdGroup7ID, prdGroup7ClientID, prdGroup7Desc,prdGroup8ID, prdGroup8ClientID, prdGroup8Desc,prdGroup9ID, prdGroup9ClientID, prdGroup9Desc,prdGroup10ID, prdGroup10ClientID, prdGroup10Desc,prdGroup11ID, prdGroup11ClientID, prdGroup11Desc,prdGroup12ID, prdGroup12ClientID, prdGroup12Desc,prdGroup13ID, prdGroup13ClientID, prdGroup13Desc,prdGroup14ID, prdGroup14ClientID, prdGroup14Desc,prdGroup15ID, prdGroup15ClientID, prdGroup15Desc,prdGroup16ID, prdGroup16ClientID, prdGroup16Desc,prdGroup17ID, prdGroup17ClientID, prdGroup17Desc,prdGroup18ID, prdGroup18ClientID, prdGroup18Desc, isActive)VALUES
("'.$ProductID.'", "'.$countryID.'","'.$prdProductClientCode.'","'.$ProductName.'","'.$prdCreatedOn.'","'.$prdGST.'","'.$prdNetWeight.'","'.$prdNetVolume.'","'.$prdGroup1ID.'","'.$prdGroup1ClientID.'","'.$prdGroup1Desc.'","'.$prdGroup2ID.'","'.$prdGroup2ClientID.'","'.$prdGroup2Desc.'","'.$prdGroup3ID.'","'.$prdGroup3ClientID.'","'.$prdGroup3Desc.'","'.$prdGroup4ID.'","'.$prdGroup4ClientID.'","'.$prdGroup4Desc.'","'.$prdGroup5ID.'","'.$prdGroup5ClientID.'","'.$prdGroup5Desc.'","'.$prdGroup6ID.'","'.$prdGroup6ClientID.'","'.$prdGroup6Desc.'","'.$prdGroup7ID.'","'.$prdGroup7ClientID.'","'.$prdGroup7Desc.'","'.$prdGroup8ID.'","'.$prdGroup8ClientID.'","'.$prdGroup8Desc.'","'.$prdGroup9ID.'","'.$prdGroup9ClientID.'","'.$prdGroup9Desc.'","'.$prdGroup10ID.'","'.$prdGroup10ClientID.'","'.$prdGroup10Desc.'","'.$prdGroup11ID.'","'.$prdGroup11ClientID.'","'.$prdGroup11Desc.'","'.$prdGroup12ID.'","'.$prdGroup12ClientID.'","'.$prdGroup12Desc.'","'.$prdGroup13ID.'","'.$prdGroup13ClientID.'","'.$prdGroup13Desc.'","'.$prdGroup14ID.'","'.$prdGroup14ClientID.'","'.$prdGroup14Desc.'","'.$prdGroup15ID.'","'.$prdGroup15ClientID.'","'.$prdGroup15Desc.'","'.$prdGroup16ID.'","'.$prdGroup16ClientID.'","'.$prdGroup16Desc.'","'.$prdGroup17ID.'","'.$prdGroup17ClientID.'","'.$prdGroup17Desc.'","'.$prdGroup18ID.'","'.$prdGroup18ClientID.'","'.$prdGroup18Desc.'","1")';
//echo $prdTemQuery;
...
//--------------------------------Group1----------------------------------------------
$tbl1=new Model;
$sql1="SELECT countryID,prdGroup1ClientID,prdGroup1Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup1ClientID";
...
{						
 foreach($res1 as $row1){
		$tbl1->_table_name= PRD_G1_TABLE;
			...
			if($g1Count == 0){
			$g1Query="INSERT INTO ".PRD_G1_TABLE."(prdGroup1ID, countryID, prdGroup1ClientID, prdGroup1Desc)VALUES('', '".$row1->countryID."', '".$row1->prdGroup1ClientID."','".$row1->prdGroup1Desc."')";
			$tbl1->query($g1Query);	
			}
	}
}
//--------------------------------Group2----------------------------------------------
$tbl2=new Model;
$sql2="SELECT countryID,prdGroup2ClientID,prdGroup2Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup2ClientID";
...
{						
 foreach($res2 as $row2){
		$tbl2->_table_name= PRD_G2_TABLE;
			...
			if($g2Count == 0){
			$g2Query="INSERT INTO ".PRD_G2_TABLE."(prdGroup2ID, countryID, prdGroup2ClientID, prdGroup2Desc)VALUES('', '".$row2->countryID."', '".$row2->prdGroup2ClientID."','".$row2->prdGroup2Desc."')";
			$tbl2->query($g2Query);	
			}
	}
}
//--------------------------------Group3----------------------------------------------
$tbl3=new Model;
$sql3="SELECT countryID,prdGroup3ClientID,prdGroup3Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup3ClientID";
...
{						
 foreach($res3 as $row3){
		$tbl3->_table_name= PRD_G3_TABLE;
			...
			if($g3Count == 0){
			$g3Query="INSERT INTO ".PRD_G3_TABLE."(prdGroup3ID, countryID, prdGroup3ClientID, prdGroup3Desc)VALUES('', '".$row3->countryID."', '".$row3->prdGroup3ClientID."','".$row3->prdGroup3Desc."')";
			$tbl3->query($g3Query);	
			}
	}
}
//--------------------------------Group4----------------------------------------------
$tbl4=new Model;
$sql4="SELECT countryID,prdGroup4ClientID,prdGroup4Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup4ClientID";
...
{						
 foreach($res4 as $row4){
		$tbl4->_table_name= PRD_G4_TABLE;
			...
			if($g4Count == 0){
			$g4Query="INSERT INTO ".PRD_G4_TABLE."(prdGroup4ID, countryID, prdGroup4ClientID, prdGroup4Desc)VALUES('', '".$row4->countryID."', '".$row4->prdGroup4ClientID."','".$row4->prdGroup4Desc."')";
			$tbl4->query($g4Query);	
			}
	}
}
//--------------------------------Group5----------------------------------------------
$tbl5=new Model;
$sql5="SELECT countryID,prdGroup5ClientID,prdGroup5Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup5ClientID";
...
{						
 foreach($res5 as $row5){
		$tbl5->_table_name= PRD_G5_TABLE;
			...
			if($g5Count == 0){
			$g5Query="INSERT INTO ".PRD_G5_TABLE."(prdGroup5ID, countryID, prdGroup5ClientID, prdGroup5Desc)VALUES('', '".$row5->countryID."', '".$row5->prdGroup5ClientID."','".$row5->prdGroup5Desc."')";
			$tbl5->query($g5Query);	
			}
	}
}
//--------------------------------Group6----------------------------------------------
$tbl6=new Model;
$sql6="SELECT countryID,prdGroup6ClientID,prdGroup6Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup6ClientID";
...
{						
 foreach($res6 as $row6){
		$tbl6->_table_name= PRD_G6_TABLE;
			...
			if($g6Count == 0){
			$g6Query="INSERT INTO ".PRD_G6_TABLE."(prdGroup6ID, countryID, prdGroup6ClientID, prdGroup6Desc)VALUES('', '".$row6->countryID."', '".$row6->prdGroup6ClientID."','".$row6->prdGroup6Desc."')";
			$tbl6->query($g6Query);	
			}
	}
}
//--------------------------------Group7----------------------------------------------
$tbl7=new Model;
$sql7="SELECT countryID,prdGroup7ClientID,prdGroup7Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup7ClientID";
...
{						
 foreach($res7 as $row7){
		$tbl7->_table_name= PRD_G7_TABLE;
			...
			if($g7Count == 0){
			$g7Query="INSERT INTO ".PRD_G7_TABLE."(prdGroup7ID, countryID, prdGroup7ClientID, prdGroup7Desc)VALUES('', '".$row7->countryID."', '".$row7->prdGroup7ClientID."','".$row7->prdGroup7Desc."')";
			$tbl7->query($g7Query);	
			}
	}
}
//--------------------------------Group8----------------------------------------------
$tbl8=new Model;
$sql8="SELECT countryID,prdGroup8ClientID,prdGroup8Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup8ClientID";
...
{						
 foreach($res8 as $row8){
		$tbl8->_table_name= PRD_G8_TABLE;
			...
			if($g8Count == 0){
			$g8Query="INSERT INTO ".PRD_G8_TABLE."(prdGroup8ID, countryID, prdGroup8ClientID, prdGroup8Desc)VALUES('', '".$row8->countryID."', '".$row8->prdGroup8ClientID."','".$row8->prdGroup8Desc."')";
			$tbl8->query($g8Query);	
			}
	}
}
//--------------------------------Group9----------------------------------------------
$tbl9=new Model;
$sql9="SELECT countryID,prdGroup9ClientID,prdGroup9Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup9ClientID";
...
{						
 foreach($res9 as $row9){
		$tbl9->_table_name= PRD_G9_TABLE;
			...
			if($g9Count == 0){
			$g9Query="INSERT INTO ".PRD_G9_TABLE."(prdGroup9ID, countryID, prdGroup9ClientID, prdGroup9Desc)VALUES('', '".$row9->countryID."', '".$row9->prdGroup9ClientID."','".$row9->prdGroup9Desc."')";
			$tbl9->query($g9Query);	
			}
	}
}
//--------------------------------Group10----------------------------------------------
$tbl10=new Model;
$sql10="SELECT countryID,prdGroup10ClientID,prdGroup10Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup10ClientID";
...
{						
 foreach($res10 as $row10){
		$tbl10->_table_name= PRD_G10_TABLE;
			...
			if($g10Count == 0){
			$g10Query="INSERT INTO ".PRD_G10_TABLE."(prdGroup10ID, countryID, prdGroup10ClientID, prdGroup10Desc)VALUES('', '".$row10->countryID."', '".$row10->prdGroup10ClientID."','".$row10->prdGroup10Desc."')";
...
//--------------------------------Group11----------------------------------------------
$tbl11=new Model;
$sql11="SELECT countryID,prdGroup11ClientID,prdGroup11Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup11ClientID";
...
{						
 foreach($res11 as $row11){
		$tbl11->_table_name= PRD_G11_TABLE;
			...
			if($g11Count == 0){
			$g11Query="INSERT INTO ".PRD_G11_TABLE."(prdGroup11ID, countryID, prdGroup11ClientID, prdGroup11Desc)VALUES('', '".$row11->countryID."', '".$row11->prdGroup11ClientID."','".$row11->prdGroup11Desc."')";
...
//--------------------------------Group12----------------------------------------------
$tbl12=new Model;
$sql12="SELECT countryID,prdGroup12ClientID,prdGroup12Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup12ClientID";
...
{						
 foreach($res12 as $row12){
		$tbl12->_table_name= PRD_G12_TABLE;
			...
			if($g12Count == 0){
			$g12Query="INSERT INTO ".PRD_G12_TABLE."(prdGroup12ID, countryID, prdGroup12ClientID, prdGroup12Desc)VALUES('', '".$row12->countryID."', '".$row12->prdGroup12ClientID."','".$row12->prdGroup12Desc."')";
...
//--------------------------------Group13----------------------------------------------
$tbl13=new Model;
$sql13="SELECT countryID,prdGroup13ClientID,prdGroup13Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup13ClientID";
...
{						
 foreach($res13 as $row13){
		$tbl13->_table_name= PRD_G13_TABLE;
			...
			if($g13Count == 0){
			$g13Query="INSERT INTO ".PRD_G13_TABLE."(prdGroup13ID, countryID, prdGroup13ClientID, prdGroup13Desc)VALUES('', '".$row13->countryID."', '".$row13->prdGroup13ClientID."','".$row13->prdGroup13Desc."')";
...
//--------------------------------Group14----------------------------------------------
$tbl14=new Model;
$sql14="SELECT countryID,prdGroup14ClientID,prdGroup14Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup14ClientID";
...
{						
 foreach($res14 as $row14){
		$tbl14->_table_name= PRD_G14_TABLE;
			...
			if($g14Count == 0){
			$g14Query="INSERT INTO ".PRD_G14_TABLE."(prdGroup14ID, countryID, prdGroup14ClientID, prdGroup14Desc)VALUES('', '".$row14->countryID."', '".$row14->prdGroup14ClientID."','".$row14->prdGroup14Desc."')";
...
//--------------------------------Group15----------------------------------------------
$tbl15=new Model;
$sql15="SELECT countryID,prdGroup15ClientID,prdGroup15Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup15ClientID";
...
{						
 foreach($res15 as $row15){
		$tbl15->_table_name= PRD_G15_TABLE;
			...
			if($g15Count == 0){
			$g15Query="INSERT INTO ".PRD_G15_TABLE."(prdGroup15ID, countryID, prdGroup15ClientID, prdGroup15Desc)VALUES('', '".$row15->countryID."', '".$row15->prdGroup15ClientID."','".$row15->prdGroup15Desc."')";
...
//--------------------------------Group16----------------------------------------------
$tbl16=new Model;
$sql16="SELECT countryID,prdGroup16ClientID,prdGroup16Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup16ClientID";
...
{						
 foreach($res16 as $row16){
		$tbl16->_table_name= PRD_G16_TABLE;
			...
			if($g16Count == 0){
			$g16Query="INSERT INTO ".PRD_G16_TABLE."(prdGroup16ID, countryID, prdGroup16ClientID, prdGroup16Desc)VALUES('', '".$row16->countryID."', '".$row16->prdGroup16ClientID."','".$row16->prdGroup16Desc."')";
...
//--------------------------------Group17----------------------------------------------
$tbl17=new Model;
$sql17="SELECT countryID,prdGroup17ClientID,prdGroup17Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup17ClientID";
...
{						
 foreach($res17 as $row17){
		$tbl17->_table_name= PRD_G17_TABLE;
			...
			if($g17Count == 0){
			$g17Query="INSERT INTO ".PRD_G17_TABLE."(prdGroup17ID, countryID, prdGroup17ClientID, prdGroup17Desc)VALUES('', '".$row17->countryID."', '".$row17->prdGroup17ClientID."','".$row17->prdGroup17Desc."')";
...
//--------------------------------Group18----------------------------------------------
$tbl18=new Model;
$sql18="SELECT countryID,prdGroup18ClientID,prdGroup18Desc FROM ".PRD_TEMP_TABLE." ORDER BY  prdGroup18ClientID";
...
{						
 foreach($res18 as $row18){
		$tbl18->_table_name= PRD_G18_TABLE;
			...
			if($g18Count == 0){
			$g18Query="INSERT INTO ".PRD_G18_TABLE."(prdGroup18ID, countryID, prdGroup18ClientID, prdGroup18Desc)VALUES('', '".$row18->countryID."', '".$row18->prdGroup18ClientID."','".$row18->prdGroup18Desc."')";
